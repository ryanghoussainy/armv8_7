...
uint32_t transfer_assembly(Instruction *ins)
{
    ...
    case UNSIGNED_OFFSET:
        ...
        result = (1 << SDT_INDICATOR_SHIFT) | (sf << TRANSFER_SF_SHIFT) | (SDT_CONSTANT << SDT_CONSTANT_SHIFT) |
    ...
    case PRE_INDEX:
        ...
        result = (1 << SDT_INDICATOR_SHIFT) | (sf << TRANSFER_SF_SHIFT) | (SDT_CONSTANT << SDT_CONSTANT_SHIFT) |
                 (L << L_SHIFT) | ((((simm9 & build_mask(0, 8)) << SIMM9_SHIFT) | ((1 << I_SHIFT) | 1)) << OFFSET_SHIFT) | (xn << XN_SHIFT) | rt;
    ...
    case POST_INDEX:
        ...
        result = (1 << SDT_INDICATOR_SHIFT) | (sf << TRANSFER_SF_SHIFT) | (SDT_CONSTANT << SDT_CONSTANT_SHIFT) |
                 (L << L_SHIFT) | ((((simm9 & build_mask(0, 8)) << SIMM9_SHIFT) + 1) << OFFSET_SHIFT) | (xn << XN_SHIFT) | rt;
    ...
    case LOAD_LITERAL:
        ...
        result = (sf << TRANSFER_SF_SHIFT) | (LL_CONSTANT << LL_CONSTANT_SHIFT) | ((ins->o2.number & build_mask(0, 18)) << SIMM19_SHIFT) | rt;
    }
